...
func main() {
	var tags = []string{"Blog", "Responsive", "Minimal", "Personal", "Light", "Dark", "Multilingual", "Portfolio", "Bootstrap", "Landing", "Dark Mode", "Docs", "Company", "Gallery", "Contact", "Archive", "unknown"}
